...
El proceso de mecanizado generalmente se divide en tres etapas principales que permiten optimizar la eficiencia, la precisión y la calidad superficial de la pieza fabricada: \textbf{desbaste} (\textit{roughing}), \textbf{semifiacabado} (\textit{semi-finishing}) y \textbf{acabado} (\textit{finishing}).
