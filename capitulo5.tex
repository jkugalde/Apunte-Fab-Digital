...
La acumulación de viruta puede minimizarse mediante el uso de herramientas con recubrimientos de baja adhesión, refrigeración, y ajustes en los parámetros de corte para evitar el régimen discontinuo que favorece este fenómeno.
...
El mecanizado generalmente se divide en tres etapas principales que permiten optimizar la eficiencia del proceso, la precisión y la calidad superficial de la pieza fabricada (Figura \ref{rofifig} y \ref{topofig}): \textbf{desbaste} (\textit{roughing}), \textbf{semiacabado} (\textit{semi-finishing}) y \textbf{acabado} (\textit{finishing}).

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{imgs/rofi.png}
	\caption{Proceso de desbaste y acabado. En el desbaste se observa una herramienta gruesa aproximando la forma desde el material base. En el acabado se observa la pieza en sus últimas etapas, siendo maquinada por una herramienta pequeña. \href{https://www.boyiprototyping.com/cnc-machining-guide/roughing-vs-finishing-in-cnc-machining/}{Fuente}}
	\label{rofifig}
\end{figure}

En el desbaste se realiza la remoción de grandes volúmenes de material con el objetivo de aproximar la forma final de la pieza desde el material base. Las condiciones de corte son agresivas, con profundidades y avances altos, buscando maximizar la tasa de arranque de material. Debido a la alta carga sobre la herramienta y las mayores vibraciones presentes, la precisión dimensional y el acabado superficial no son prioritarios en esta fase. Se emplean herramientas robustas y estrategias que priorizan la rapidez y la eficiencia en la eliminación del material sobrante.

El semifinishing busca refinar la geometría aproximada obtenida durante el desbaste, eliminando las irregularidades y preparando la pieza para la etapa final, generalmente disminuyendo el diámetro de la herramienta. Los parámetros de corte se ajustan para reducir la carga sobre la herramienta y mejorar la precisión dimensional. Se disminuyen las profundidades y avances para disminuir la generación de vibraciones y mejorar la estabilidad del proceso. El acabado superficial comienza a mejorar, aunque generalmente no se alcanzan los niveles de calidad requeridos para el producto final.

Finalmente, en el acabado se utilizan herramientas pequeñas, reduciendo velocidades de avance y pasos de profundidad, aumentando la precisión dimensional y el acabado superficial. El objetivo principal es cumplir con las tolerancias más estrictas y obtener superficies lisas que cumplan con los requerimientos funcionales y estéticos de la pieza.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{imgs/topo.png}
	\caption{Fresado de topología, a la derecha se observa una etapa de mecanizado más avanzada, alcanzando mayor resolución que su símil izquierdo. \href{https://es.pinterest.com/pin/807973989371688121/}{Fuente}}
	\label{topofig}
\end{figure}
...
El parámetro \textit{stock to leave} (Figura \ref{stokfig}) representa la cantidad de material residual que se deja intencionalmente sobre la geometría final, pudiendo ser radial (hacia los lados) o axial (hacia arriba). Este valor asegura un margen para las siguientes etapas de mecanizado, facilitando un acabado más preciso. Habitualmente, se procura mantener este valor bajo, con el fin de minimizar la carga de trabajo en las herramientas de acabado, que suelen ser más delicadas y costosas.

\begin{figure}[h!]
	\centering
	\includegraphics[width=0.6\linewidth]{imgs/stokto.png}
	\caption{Stock to leave o sobrematerial. A la izquierda se observa un límite del mecanizado desplazado radialmente hacia el interior de la geometría objetivo, a la derecha, hacia el exterior. Fuente: Autodesk Fusion360}
	\label{stokfig}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.7\linewidth]{imgs/estepoper.png}
	\caption{Se observa el error dimensional inducido por el tamaño del paso en vertical u horizontal al maquinar con una fresa de bola. \href{https://zero-divide.net/?article_id=4509_tips-on-surface-milling-with-ballnose-endmills}{Fuente}}
	\label{bols}
\end{figure}
 
\subsection{Operaciones 2D}

En el fresado CNC bidimensional (2D), la herramienta se desplaza principalmente en los ejes \textit{X} e \textit{Y}, con profundidades constantes en el eje \textit{Z}. Estas operaciones son las más sencillas y frecuentes en corte CNC, especialmente al momento de trabajar con planchas de material. Las más comunes son (Figura \ref{2dopfig}):
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\linewidth]{imgs/2dop.png}
	\caption{Operaciones 2D comunes, las trayectorias de corte aparecen en azul, mientras que los movimientos de aproximación en amarillo. Fuente: Fusion Autodesk 360.}
	\label{2dopfig}
\end{figure}
...
En este tipo de operaciones, la herramienta suele desplazarse en trayectorias tridimensionales que siguen el perfil de la pieza. A continuación se describen las estrategias más comunes (Figura \ref{3dopsfig}):
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=1.0\linewidth]{imgs/3dops.png}
	\caption{Operaciones 3D comunes, las trayectorias de corte aparecen en azul, mientras que los movimientos de aproximación en amarillo. Fuente: Fusion Autodesk 360.}
	\label{3dopsfig}
\end{figure}
