...
\begin{table}[h!]
	\centering
	\caption{Rangos típicos de fluencia en $\si{\J\per\centi\meter\squared}$ para mecanismos de acción en acero al carbono (A36–1020).}
	\label{fluencias}
	\begin{tabular}{|c|c|c|c|c|}
		\hline
		\textbf{Calentamiento} &
		\textbf{Microestructura} &
		\textbf{Fusión} &
		\textbf{Vaporización} &
		\textbf{Ablación} \\
		\hline
