...
Las máquinas automatizadas de fabricación digital o CNCs son \textbf{sistemas mecatrónicos} programables que ejecutan procesos de fabricación mediante un set de instrucciones definido en un programa. Incluyen tecnologías como la impresión 3D, torneado, fresado y corte láser, entre otros. Se caracterizan por su precisión, repetibilidad y autonomía operativa, lo que les permite \textbf{fabricar piezas diversas y complejas de manera sencilla}. En este capítulo se tratarán las características generales de una máquina de este tipo.
